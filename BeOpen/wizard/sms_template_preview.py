...
class email_template(osv.osv):
    ...
    def generate_SMS(self, cr, uid, template_id, res_id, context=None):
        if context is None:
            context = {}
...
class sms_template_preview(osv.osv_memory):
    _inherit = "email.template"
    ...
    def on_change_res_id(self, cr, uid, ids, res_id, context=None):
        ...
        mail_values = email_template.generate_SMS(cr, uid, template_id, res_id, context=context)
